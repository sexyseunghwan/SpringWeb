	...
	<div class="container">
		...
		<form method="POST" action="/spring/editok.action">
			<table class="table table-bordered tblAdd">
				<tr>
					<th>이름</th>
					<td><input type="text" name="name" required class = "form-control" value="${dto.name}"></td><!-- name 의 이름이 DTO 의 이름과 같아야  즉 name 으로 지정해야 한다!(대소문자도 가리니까 똑같이 만들어야 한다!.) spring 의 도움을 많이 받을 수 있다. -->
				</tr>
				<tr>
					<th>메모</th>
