...
//서블릿 역할 + 컨트롤러
@Controller
@RequestMapping(value="/ex04.action")//이런식으로 해주면 servlet-context에 갈 필요가 없어진다. <beans:bean class="com.test.spring.Ex04Controller" name="/ex04.action"></beans:bean> 애들 그냥 만들어준다고 생각하면 된다.
public class Ex04Controller {
	...
	public String test() {
		...
		return "ex04";//WEB-INF/views/ex04.jsp 를 뜻하는것임. -> 이게 jsp 를 찾아감 그냥 리턴 저렇게 써도
